...
export default function UserFormBodyMetrics({ form, errors, onChange, onBack, onNext, disabled }) { 
  ...
  const canInputBodyMetrics = hasPermission('edit_users') || hasPermission('create_users');
    ...
    <fieldset className="section">
      ...
      <div className="formGrid">
        <FormField 
          ...
          max="300" 
          step="0.1" 
          disabled={disabled || !canInputBodyMetrics}
          title={!canInputBodyMetrics ? "אין לך הרשאות להזין מדדים גופניים" : ""}
        />
        <FormField 
          name="height" 
          label="גובה (ס״מ)" 
