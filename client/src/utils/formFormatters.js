...
const payload = {
    ...
    birth_date: formatToISODate(form.birth_date) || "",
  ...
  if (form.recorded_at) payload.recorded_at = formatToISODate(form.recorded_at);
  if (form.start_date) payload.start_date = formatToISODate(form.start_date);
  if (form.end_date) payload.end_date = formatToISODate(form.end_date);
